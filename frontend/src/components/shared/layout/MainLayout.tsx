...
export default function MainLayout({ children }: MainLayoutProps) {
    ...
    // On server, we default to 'system-master' to match initial client render
    const projectId = (params.projectId as string) || searchParams.get('projectId') || 'system-master';
